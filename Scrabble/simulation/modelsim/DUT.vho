...
SIGNAL \add_instance|J3|Y~combout\ : std_logic;
...
\add_instance|J3|Y\ : maxv_lcell
-- Equation(s):
-- \add_instance|J3|Y~combout\ = (\input_vector~combout\(2) & (\input_vector~combout\(3) & (\input_vector~combout\(1) $ (\input_vector~combout\(0))))) # (!\input_vector~combout\(2) & (!\input_vector~combout\(3) & (\input_vector~combout\(1) $ 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|J3|Y~combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|J3|Y~combout\,
	oe => VCC,
