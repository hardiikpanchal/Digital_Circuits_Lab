...
SIGNAL \add_instance|u4|Y~0_combout\ : std_logic;
...
\add_instance|u4|Y~0\ : maxv_lcell
-- Equation(s):
-- \add_instance|u4|Y~0_combout\ = ((\input_vector~combout\(0) & ((\input_vector~combout\(2)))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|u4|Y~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|u4|Y~0_combout\,
	oe => VCC,
