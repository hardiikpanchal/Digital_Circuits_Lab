...
SIGNAL \add_instance|op\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \add_instance|ALT_INV_op\ : std_logic_vector(0 DOWNTO 0);
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|ALT_INV_op\(0) <= NOT \add_instance|op\(0);
...
\add_instance|op[0]\ : maxv_lcell
-- Equation(s):
-- \add_instance|op\(0) = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(2) & \input_vector~combout\(3)))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|ALT_INV_op\(0),
	oe => VCC,
