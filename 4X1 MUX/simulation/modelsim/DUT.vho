...
SIGNAL \dut_instance|add_instance|M3|u4|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|M3|u4|Y~1\ : std_logic;
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & (\dut_instance|add_instance|M3|u4|Y~1\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (((datau(0))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|M3|u4|Y~1\,
...
-- Equation(s):
-- \dut_instance|add_instance|M3|u4|Y~0\ = (dut_input(0) & (((dut_input[3]) # (dut_input(1))))) # (!dut_input(0) & (dut_input(2) & ((!dut_input(1)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|M3|u4|Y~0\,
	regout => dut_input(3));

-- Location: LC_X8_Y5_N5
\dut_input[4]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|M3|u4|Y~1\ = (dut_input(1) & ((\dut_instance|add_instance|M3|u4|Y~0\ & (dut_input(5))) # (!\dut_instance|add_instance|M3|u4|Y~0\ & ((dut_input[4]))))) # (!dut_input(1) & (((\dut_instance|add_instance|M3|u4|Y~0\))))
...
PORT MAP (
	...
	datab => dut_input(5),
	datac => data(4),
	datad => \dut_instance|add_instance|M3|u4|Y~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|M3|u4|Y~1\,
	regout => dut_input(4));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|M3|u4|Y~1\,
	oe => VCC,
