...
-- Equation(s):
-- \add_instance|op\(0) = (\input_vector~combout\(0) & (!\input_vector~combout\(1) & (\input_vector~combout\(3) $ (!\input_vector~combout\(2))))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1) & (\input_vector~combout\(3) $ 
