...
SIGNAL \add_instance|Selector3~0\ : std_logic;
...
-- Equation(s):
-- \add_instance|Selector4~0\ = ((\input_vector~combout\(1) & ((B1_y_present.lt) # (!\input_vector~combout\(2)))) # (!\input_vector~combout\(1) & (B1_y_present.lt & !\input_vector~combout\(2))))
...
-- Equation(s):
-- \add_instance|Selector3~0\ = ((\input_vector~combout\(1) & (B1_y_present.gt & \input_vector~combout\(2))) # (!\input_vector~combout\(1) & ((B1_y_present.gt) # (\input_vector~combout\(2)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|Selector3~0\,
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|Selector4~0\,
	oe => VCC,
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|Selector3~0\,
	oe => VCC,
