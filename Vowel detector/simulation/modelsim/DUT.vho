...
SIGNAL \add_instance|H4|Y~combout\ : std_logic;
SIGNAL \input_vector~combout\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \add_instance|H4|ALT_INV_Y~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|H4|ALT_INV_Y~combout\ <= NOT \add_instance|H4|Y~combout\;
...
\add_instance|H4|Y\ : maxv_lcell
-- Equation(s):
-- \add_instance|H4|Y~combout\ = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(2) & \input_vector~combout\(3)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|H4|Y~combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|H4|ALT_INV_Y~combout\,
	oe => VCC,
